...
export default function DashboardPage() {
  ...
  <div className="flex flex-col md:flex-row gap-6 p-6">
    ...
    <div className="flex-1 bg-white rounded-2xl shadow p-4 border-1 border-gray-200">
      ...
      <a href="#" className="text-sm text-yellow-700 font-bold hover:underline">View all</a>
      </div>
      ...
      <div className="mb-4 border-b pb-4 flex flex-row space-x-2">
        ...
        <div>
          ...
          <span className="flex flex-row text-xs"><Clock size={15}/>1 day ago</span>
          </div>
          
          <p className="text-sm text-gray-500">Supervisor, Information Technology</p>
          <h3 className="font-bold mt-2">Accessibility in Design</h3>
          <p className="text-sm text-gray-600 mt-1">
            Attached below is a link to an article on accessibility in design,
            this will help you gain knowledge in creating user-centric...
          </p>
          <div className="flex items-center gap-5 text-sm mt-2">
            <span className="flex flex-row gap-2"><ThumbsUp size={20} className="text-red-500" /> 5</span>
            <span className="flex flex-row gap-2"><Reply size={20} className="text-gray-400" /> 1 reply</span>
          </div>
        </div>
      </div>
    ...
    <div className="w-full md:w-1/3 bg-white rounded-2xl shadow p-4 border border-gray-200">
      ...
      <div className="mb-4 border-b pb-3">
        <div></div>
        <p className="font-bold"> You’ve been assigned an Intern <span className="bg-yellow-100 text-[#202020] text-xs font-semibold ml-2 px-2 py-1 rounded-full">New</span></p>
        <p className="text-sm text-gray-600">Benita Ajagunna has been assigned to you. UI/UX Team</p>
        <p className="text-xs text-gray-400 mt-1 flex flex-row gap-1"><Clock size={15} />2 mins ago</p>
      </div>

      <div className="mb-4 border-b pb-3">
        <p className="font-bold"> Project Submitted <span className="bg-yellow-100 text-[#202020] text-xs font-semibold ml-2 px-2 py-1 rounded-full">New</span></p>
        <p className="text-sm text-gray-600">Benita Ajagunna submitted Database Schema for review</p>
        <p className="text-xs text-gray-400 mt-1 flex flex-row gap-1"><Clock size={15} />4 mins ago</p>
      </div>

      <div>
        <p className="font-bold"> Internship Ending in 2 Weeks</p>
        <p className="text-sm text-gray-600">Buhari Riko’s Internship is ending in two weeks</p>
        <p className="text-xs text-gray-400 mt-1 flex flex-row gap-1"><Clock size={15} />6 hours ago</p>
      </div>
    </div>
  </div>
</div>
